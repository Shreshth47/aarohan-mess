  ...
  return (
    <main className="container mx-auto px-4 py-8">
          ...
          <tbody>
            {collegeData.map((college, i) => (
              ...
              >
                ...
                <td className="px-6 py-4">{college.totalTeams}</td>
                <td className="px-6 py-4">{college.totalTeamMates}</td>
                <td className="px-6 py-4 text-right">
                  <a
                    href={`/download/college?collegeName=${college.collegeName}`}
      ...
      <div className="mt-8">
        ...
        <a
          className="bg-green-500 px-6 py-2 text-white rounded-md hover:bg-green-800"
          href={`/download/sport?sport=${sport}`}
          target="_blank"
        >
          Download
        </a>
      ...
      <div className="mt-5">
        <a
          className="bg-red-500 px-6 py-2 text-white rounded-md hover:bg-red-800"
          href="/mess"
        >
          Attendance
        </a>
